...
class Matern52(AbstractKernel):
	...
	print "Inputs 2"
	print inputs_2
        r2  = np.abs(kernel_utils.dist2(self.ls, inputs_1, inputs_2))
        r   = np.sqrt(r2)
    ...
    def cross_cov_grad_data(self, inputs_1, inputs_2):
        ...
        return grad_r2[:,:,np.newaxis] * kernel_utils.grad_dist2(self.ls, inputs_1, inputs_2)
...
if __name__ == '__main__':
 ...
 [ 1.,          0.,          0.,          0.,          0.,          1.,
   ...
   0.02063379]])
	...
	print k.cross_cov(inputs_1, inputs_2)
