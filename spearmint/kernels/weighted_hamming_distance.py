...
class WeightedHammingDistance(AbstractKernel):

    def __init__(self, num_dims, value=None, name='WeightedHammingDistance', prior=None, conditioning=None):
        self.name     = name
    ...
    def kroneker_delta(self, x, y):
	return 

    def cross_cov(self, inputs_1, inputs_2):
	import pdb; pdb.set_trace();
	cov = np.exp(np.sum(-self.ls.value*self.kroneker_delta(inputs_1, inputs_2)))
    ...
    def cross_cov_grad_data(self, inputs_1, inputs_2):
        ...
        grad_r2_x1 = kernel_utils.grad_dist2(self.ls.value, inputs_1, inputs_2, self.conditioning)
